...
def count_objects(frame):
    ...
    # Reset object count for the current frame
    object_count = 0
    ...
    cv2.putText(frame_with_text, f'Object count: {object_count}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
while(True):
    ...
    # Count objects in the frame and mirror it
    mirrored_frame = count_objects(frame)
